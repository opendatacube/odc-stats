...
def test_rolling_season_binner():
    ...
    seasons_rules = {
        "2000-02--P3M": DateTimeRange(datetime(2000, 2, 1, 0, 0), "3M"),
        "2000-03--P3M": DateTimeRange(datetime(2000, 3, 1, 0, 0), "3M"),
        "2000-04--P3M": DateTimeRange(datetime(2000, 4, 1, 0, 0), "3M"),
        "2000-05--P3M": DateTimeRange(datetime(2000, 5, 1, 0, 0), "3M"),
    }
