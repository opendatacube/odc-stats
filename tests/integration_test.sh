...
odc-stats save-tasks --config https://raw.githubusercontent.com/GeoscienceAustralia/dea-config/update_stats_configs/dev/services/odc-stats/geomedian/ga_ls8c_nbart_gm_cyear_3.yaml --year=2015 --overwrite geomad-eo3-test-run.db
